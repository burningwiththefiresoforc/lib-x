### Fixes 1.8.5
- Attempted to speed up the initial database load (dubious whether it was successful, it's pretty bottlenecked now and would need complex parallel processing or some other witchcraft to speed it up). It's probably not going to get much smaller or faster from here on out.  
